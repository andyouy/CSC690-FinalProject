...
protocol TargetLanguagePickerDelegate: AnyObject{
    func targetLanguageSelected(_ language: Language)
}

class TargetLanguageViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    
    @IBOutlet weak var targetLanguagePicker: UIPickerView!
    
    weak var delegate: TargetLanguagePickerDelegate?
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        let targetSelectedLanguage = languages[row]
        
        dismiss(animated: true, completion: nil)
        
        delegate?.targetLanguageSelected(targetSelectedLanguage)
